"""
This is the script for deploying the model from train_onewave.py. It should
be edited based on whichever model from your training script does best with 
respect to the number of steps. It should also be run alongside test_twowave.py
to generate the two car racing simulation.
"""
...
RUN_ID = "fast"
MODEL_STEPS = 180000  # Load model trained for 200k steps
        ...
        try:
            ...
            while step_count < max_steps and not done:
                try:
                    ...
                    # Calculate step penalty based on CTE
...
if __name__ == '__main__':
    try:
        print("Starting DonkeyCar Model Test")
        print("=" * 50)
        ...
        model_path = f'ppo_donkeycar_stable_best_{RUN_ID}_{MODEL_STEPS}'
        ...
        # Run test episodes
        print(f"\nStarting test with model trained for {MODEL_STEPS} steps...")
